...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::export_config_envelope,
            ...
            commands::tauri_get_files_modified_times,
            commands::tauri_clear_texture_thumbnail_cache,
            ...
            commands::soundbank_build,
            commands::soundbank_parse,
            commands::tauri_get_soundbank_info,
            commands::wwiselookup_parse,
            commands::wwiselookup_patch,
            commands::bnk_parse_full,
            commands::bnk_extract_wems,
            commands::wem_preview_audio,
            commands::wem_get_info_and_preview,
            commands::soundbank_extract_bnk,
            commands::bnk_batch_inject_wems,
            commands::bnk_scan_wem_folder,
        ])
